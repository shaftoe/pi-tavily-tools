...
- **ci**: add missing @semantic-release/npm plugin
...
- ignore 202 responses from https://api.tavily.com/usage
...
- **deps**: update dependencies to latest stable versions (#30)
- **tests**: update test for latest release
...
[unreleased]: https://github.com/shaftoe/pi-tavily-tools/compare/v0.6.5...HEAD
